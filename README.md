...
Our models (not released here) are built from [Wan2.1](https://github.com/Wan-Video/Wan2.1), [Matrix-Game-2](https://github.com/SkyworkAI/Matrix-Game). The data engine for CLIGen are built from [Asciinema](https://github.com/search?q=asciinema&type=repositories), [VHS](https://github.com/search?q=vhs&type=repositories), and data engine for GUIWorld ([`synthetic_data_collection`](https://github.com/metauto-ai/NeuralComputer/tree/main/engine/gui/synthetic_data_collection)) are modified and improved directly from [Neural-OS](https://neural-os.com/), we built GUIWorld ([`computer_use_agent`](https://github.com/metauto-ai/NeuralComputer/tree/main/engine/gui/computer_use_agent)) ourself.
