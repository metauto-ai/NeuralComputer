...
try:
    ...
    print("Warning: cairosvg or PIL not available, cursor drawing will be disabled")
    svg2png = None
    Image = None
    ImageDraw = None
...
base_directory = '/home/computeruse/agent_recordings'
    ...
    with mss.mss(with_cursor=True) as sct:
        ...
        try:
            ...
            for i, ((x, y), should_click, should_right_click, key_events) in enumerate(trajectory):
                ...
                # Use xdotool instead of pyautogui
